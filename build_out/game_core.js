...
var ASM_CONSTS = {
  ...
  88760: () => Module.canvas.width,
  88792: () => parseInt(Module.canvas.style.width),
  88840: () => {
  ...
  89263: () => window.innerWidth,
  89289: () => window.innerHeight,
  89316: () => {
    if (document.fullscreenElement) return 1;
  },
  89362: () => Module.canvas.width,
  89394: () => parseInt(Module.canvas.style.width),
  89442: () => {
    if (document.fullscreenElement) return 1;
  },
  89488: () => Module.canvas.width,
  89520: () => screen.width,
  89545: () => window.innerWidth,
  89571: () => window.innerHeight,
  89598: () => {
    if (document.fullscreenElement) return 1;
  },
  89644: () => Module.canvas.width,
  89676: () => screen.width,
  89701: () => {
    document.exitFullscreen();
  },
  ...
  89774: () => Module.canvas.width,
  89806: () => parseInt(Module.canvas.style.width),
  89854: () => {
    document.exitFullscreen();
  },
  89881: $0 => {
  ...
  89919: () => screen.width,
  89944: () => screen.height,
  89970: () => window.screenX,
  89997: () => window.screenY,
  90024: () => window.devicePixelRatio,
  90060: $0 => {
  ...
  90601: () => window.innerWidth,
  90627: () => window.innerHeight
};
...
var _run_emulator = Module["_run_emulator"] = makeInvalidEarlyAccess("_run_emulator");

var _update_gps_from_js = Module["_update_gps_from_js"] = makeInvalidEarlyAccess("_update_gps_from_js");
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports["run_emulator"] != "undefined", "missing Wasm export: run_emulator");
  assert(typeof wasmExports["update_gps_from_js"] != "undefined", "missing Wasm export: update_gps_from_js");
  ...
  _run_emulator = Module["_run_emulator"] = createExportWrapper("run_emulator", 0);
  _update_gps_from_js = Module["_update_gps_from_js"] = createExportWrapper("update_gps_from_js", 0);
