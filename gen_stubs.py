...
def generate_stubs(input_file):
    ...
    SIGNATURE_MAP = {
        ...
        "wcrtomb": "int wcrtomb(char *s, int wc, void *ps) { return 0; }",
        ...
        "posix_memalign": "int posix_memalign(void **memptr, size_t alignment, size_t size) { return 0; }",
        "pthread_mutex_trylock": "int pthread_mutex_trylock(void *mutex) { return 0; }",
        "raise": "int raise(int sig) { return 0; }",
        ...
        "strnlen": "size_t strnlen(const char *s, size_t maxlen) { return 0; }",
        "lseek": "long long lseek(int fd, long long offset, int whence) { return 0; }",
    ...
    ignore_list = { "dlopen", "dlsym", "dlclose", "dlerror", "printf", "fprintf", "snprintf" } # 適宜追加
